...
if ($_POST) {
    ...
    if (empty($nama_siswa)) {
        ...
        if (empty($password)) {
            ...
            nama_siswa='" . $nama_siswa . "',tanggal_lahir='" . $tanggal_lahir . "',
            gender='" . $gender . "', alamat='" . $alamat . "', username='" . $username . "',
            id_kelas='" . $id_kelas . "' WHERE id_siswa = '" . $id_siswa . "'") or
            ...
            '" . $id_siswa . "'") or die(mysqli_error($koneksi));
